...
if __name__ == "__main__":
    ...
    aggregated_accelerometer_train_data = Accalerometer_Preprocessing('/kaggle/input/child-mind-institute-problematic-internet-use/series_train.parquet')
    train_df = pd.merge(train_df, aggregated_accelerometer_train_data.aggregations, how='outer')
    ...
    aggregated_accelerometer_test_data = Accalerometer_Preprocessing("/kaggle/input/child-mind-institute-problematic-internet-use/series_test.parquet")
    test_df = pd.merge(test_df, aggregated_accelerometer_test_data.aggregations, how='outer')
